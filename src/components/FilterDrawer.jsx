...
const FilterDrawer = ({state,setState,rangeValue,setRangeValue,setSort,handleChange,catId}) => {
  ...
  return (
    <div className={`fixed w-80 sm:w-96 bg-white top-0 bottom-0 ${state ? '-translate-x-[0%]' : '-translate-x-[100%]'} transition-transform duration-500 drop-shadow-xl will-change-transform z-50`}>
